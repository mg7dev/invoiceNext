<ul class="sidebar-menu">
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.account') }}" class="sidebar-menu-button {{ $tab == 'account' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.notifications') }}" class="sidebar-menu-button {{ $tab == 'notification' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.company') }}" class="sidebar-menu-button {{ $tab == 'company' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.preferences') }}" class="sidebar-menu-button {{ $tab == 'preferences' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.invoice') }}" class="sidebar-menu-button {{ $tab == 'invoice' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.estimate') }}" class="sidebar-menu-button {{ $tab == 'estimate' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.payment') }}" class="sidebar-menu-button {{ $tab == 'payment' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.product') }}" class="sidebar-menu-button {{ $tab == 'product' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.tax_types') }}" class="sidebar-menu-button {{ $tab == 'tax_types' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.expense_categories') }}" class="sidebar-menu-button {{ $tab == 'expense_categories' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.email_template') }}" class="sidebar-menu-button {{ $tab == 'email_template' ? 'btn-selected' : 'text-secondary' }}">
    ...
    <li class="sidebar-menu-item">
        <a href="{{ route('settings.team') }}" class="sidebar-menu-button {{ $tab == 'team' ? 'btn-selected' : 'text-secondary' }}">
